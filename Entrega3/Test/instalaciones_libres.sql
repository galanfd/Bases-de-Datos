...
BEGIN
    ...
    query_instalacion := 'SELECT Instalaciones.id_instalacion, Instalaciones.capacidad FROM Puertos, Puerto_Instalacion, Instalaciones WHERE Puertos.id_puerto = Puerto_Instalacion.id_puerto AND Puerto_Instalacion.id_instalacion = Instalacion.id_instalacion AND Puertos.id_puerto = sleccion_puerto';
